# Contributing to DiscordRPC

We would love for you to contribute to DiscordRPC Project and help make it ever better together! :rocket:
...
Help us keep DiscordRPC open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `DiscordRPC`.
...
* If you have a question about using DiscordRPC, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `DiscordRPC:master`.
...
we use the git commit messages to **generate the DiscordRPC change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/NebraskyTheWolf/DiscordRPC
[stackoverflow]: https://discord.gg/
[issues]: https://github.com/NebraskyTheWolf/DiscordRPC/issues
[new_issue]: https://github.com/NebraskyTheWolf/DiscordRPC/issues/new
[pulls]: https://github.com/NebraskyTheWolf/DiscordRPC/pulls
